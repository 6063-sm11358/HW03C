...
function draw() {
  fill('#EBEBEB');
  let dim = 10;                             //setting circle diameter value
  let maxCircles = 1000;                    //setting max no.of circles to draw
  ...
  for(let i=1;i<=maxCircles;i++)            //looping to generate 1000 circles
  {
